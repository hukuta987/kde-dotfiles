...
class BurnMyWindowsPixelWipeEffect {
  constructor() {
    ...
    this.shader = effect.addFragmentShader(Effect.MapTexture, 'pixel-wipe.frag');
  ...
  slotWindowAdded(window) {
    ...
    if (!BurnMyWindowsPixelWipeEffect.shouldAnimateWindow(window)) {
      return;
    }
    if (!window.visible) {
      return;
...
new BurnMyWindowsPixelWipeEffect();
